...
import { updateQuoteApi } from "../../Api's/QuoteApi"; // Adjust this path as needed
// import { updateQuoteRedux } from "../../Redux/slice/quoteSlice"; // Adjust this path as needed
...
export function UpdateQuote({
  ...
  }, [initialQuoteItems, initialStatus]);
  ...
  const updateQuoteDetails = async () => {
    ...
    try {
      const response = await axios.put(updateQuoteApi(quoteId), data, {
        headers: {
