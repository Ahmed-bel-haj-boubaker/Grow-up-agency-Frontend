...
import { updateCategories } from "../../Api's/CategoriesApi";
import { useDispatch } from "react-redux";
import { updateCategoriesRedux } from "../../Redux/slice/categoriesSlice";

export function UpdateCategories({ categoryId, initialName, initialImage }) {
  ...
  const updateCategoryDetails = async () => {
    ...
    try {
      ...
      dispatch(
        updateCategoriesRedux({ category: response.data.updatedDocument })
      );
